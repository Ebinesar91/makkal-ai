  ...
  return (
    <div className="flex min-h-svh flex-col bg-cream lg:flex-row">
      ...
      <main className="min-w-0 flex-1 p-6 sm:p-8">
        <h1 className="font-manrope text-[24px] font-extrabold text-navy">பொறுப்புடைமை / Officer Accountability</h1>
        <p className="mt-1 font-inter text-[13px] text-muted">
          Individual turnaround metrics & officer performance audits
        </p>
        <div className="mt-6 rounded-2xl border border-line bg-white p-6 shadow-sm">
          <p className="font-manrope text-[14px] leading-[1.6] text-ink">
            Officer Profile: K. Rajendran, IAS — Spl. Commissioner. Pending reviews: 14. Average turnaround: 3.2 days. SLA adherence: 98.4%.
          </p>
        </div>
      </main>
    </div>
