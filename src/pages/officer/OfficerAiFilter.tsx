...
export function OfficerAiFilter() {
  ...
  return (
    <div className="flex min-h-svh flex-col bg-cream lg:flex-row">
      ...
      <main className="min-w-0 flex-1 p-6 sm:p-8">
        <h1 className="font-manrope text-[24px] font-extrabold text-navy">AI வடிகட்டி / AI Filter Assistant</h1>
        <p className="mt-1 font-inter text-[13px] text-muted">
          Natural language filter assistant for large officer queues
        </p>
        <div className="mt-6 rounded-2xl border border-line bg-white p-6 shadow-sm">
          <p className="font-manrope text-[14px] leading-[1.6] text-ink">
            Filter query assistant: &quot;Show scholarship applications older than 10 days, high priority, Chennai district.&quot;
          </p>
        </div>
      </main>
    </div>
