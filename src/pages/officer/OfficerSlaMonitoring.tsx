...
export function OfficerSlaMonitoring() {
  ...
  return (
    <div className="flex min-h-svh flex-col bg-cream lg:flex-row">
      ...
      <main className="min-w-0 flex-1 p-6 sm:p-8">
        <h1 className="font-manrope text-[24px] font-extrabold text-navy">SLA கண்காணிப்பு / SLA Monitoring</h1>
        <p className="mt-1 font-inter text-[13px] text-muted">
          Statewide SLA adherence, warnings, and breach tracking
        </p>
        <div className="mt-6 rounded-2xl border border-line bg-white p-6 shadow-sm">
          <p className="font-manrope text-[14px] leading-[1.6] text-ink">
            112 applications in SLA warning. 16 breached. Heatmap by department: Higher Education, Social Welfare, Agriculture.
          </p>
        </div>
      </main>
    </div>
